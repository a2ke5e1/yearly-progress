...
class CalendarWidget : BaseWidget() {
  ...
  private fun setFontScale(
    ...
    val widgetEventDescription =
        scaledFontSizeInSp(defaultCalendarWidgetFontSize.widgetEventDescription)
    ...
    view.setTextViewTextSize(
        R.id.event_description, TypedValue.COMPLEX_UNIT_SP, widgetEventDescription)
  ...
  private val defaultFontScale =
      DefaultCalendarWidgetFontSize(
  ...
  private val defaultSmallFontScale =
      DefaultCalendarWidgetFontSize(
          R.dimen.calendar_widget_event_status,
          R.dimen.calendar_widget_event_title,
          R.dimen.calendar_widget_event_description,
